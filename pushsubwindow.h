#ifndef PUSHSUBWINDOW_H
#define PUSHSUBWINDOW_H
...
class PushSubWindow : public QMainWindow
{
    Q_OBJECT

public:
    explicit PushSubWindow(MainWindow *mainWinPtr, QWidget *parent = 0);
    ~PushSubWindow();
