#ifndef SKINSLIPSUBWINDOW_H
#define SKINSLIPSUBWINDOW_H
...
class SkinSlipSubWindow : public QMainWindow
{
    Q_OBJECT

public:
    explicit SkinSlipSubWindow(MainWindow *mainWinPtr, QWidget *parent = 0);
    ~SkinSlipSubWindow();
...
private:
    Ui::SkinSlipSubWindow *ui;
    MainWindow *mainWindowPtr;
};

#endif // SKINSLIPSUBWINDOW_H
