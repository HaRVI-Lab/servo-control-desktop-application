#ifndef SKINSLIPDELAYSUBWINDOW_H
#define SKINSLIPDELAYSUBWINDOW_H
...
class SkinSlipDelaySubWindow : public QMainWindow
{
    Q_OBJECT

public:
    explicit SkinSlipDelaySubWindow(MainWindow *mainWinPtr, QWidget *parent = 0);
    ~SkinSlipDelaySubWindow();
...
private:
    Ui::SkinSlipDelaySubWindow *ui;
    MainWindow *mainWindowPtr;
};

#endif // SKINSLIPDELAYSUBWINDOW_H
