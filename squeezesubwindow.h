#ifndef SQUEEZESUBWINDOW_H
#define SQUEEZESUBWINDOW_H
...
class SqueezeSubWindow : public QMainWindow
{
    Q_OBJECT

public:
    explicit SqueezeSubWindow(MainWindow *mainWinPtr, QWidget *parent = 0);
    ~SqueezeSubWindow();
...
private:
    Ui::SqueezeSubWindow *ui;
    MainWindow *mainWindowPtr;
    int firstReset = 1;
};

#endif // SQUEEZESUBWINDOW_H
