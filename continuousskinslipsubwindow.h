#ifndef CONTINUOUSSKINSLIPSUBWINDOW_H
#define CONTINUOUSSKINSLIPSUBWINDOW_H
...
class ContinuousSkinSlipSubWindow : public QMainWindow
{
    Q_OBJECT

public:
    explicit ContinuousSkinSlipSubWindow(MainWindow *mainWinPtr, QWidget *parent = 0);
    ~ContinuousSkinSlipSubWindow();
...
private:
    Ui::ContinuousSkinSlipSubWindow *ui;
    MainWindow *mainWindowPtr;
};

#endif // CONTINUOUSSKINSLIPSUBWINDOW_H
